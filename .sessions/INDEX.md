...
|---|---|---|---|
| 2026-06-06 | [issues-51-57-tdd](2026-06-06__issues-51-57-tdd/handoff.md) | TDD Issues 51–57: daily runs row, retention basename sweep, dashboard basename match, next-run countdown, operator overrides (reschedule/edit-title), Hermes consume-side (`directed` + narration branch); 30 new tests green; 2 orphan MP4s cleaned | Issue 58 HITL: configure Hermes director + first directed script E2E |
